...
const light = {
  ...
  // ---------------------------------------------------------------------------
  surface: "#F5F8FC", // primary canvas, most of every screen
  onSurface: "#0B1F3A", // text and icons on the canvas
  surfaceSecondary: "#FFFFFF", // cards, sheets, list rows
  onSurfaceSecondary: "#213958", // text and icons on cards, sheets, rows
  surfaceTertiary: "#EAF1F8", // input backgrounds, chips, deepest nesting
  onSurfaceTertiary: "#58708C", // text on inputs and chips; also muted text
  surfaceInverse: "#0B1F3A", // tooltips, snackbars, anything popping against the theme
  ...
  // ---------------------------------------------------------------------------
  brand: "#0B1F3A", // base hue, anchor only; Primary, Secondary, Tertiary are weights of it
  onBrand: "#FFFFFF", // text and icons placed directly on brand
  brandPrimary: "#0B63CE", // primary CTA, active tab indicator, selected states
  onBrandPrimary: "#FFFFFF", // text and icons on brandPrimary
  brandSecondary: "#DCEBFA", // secondary CTA, less prominent accents
  onBrandSecondary: "#0B1F3A", // text and icons on brandSecondary
  brandTertiary: "#EAF4FF", // chips, tags, badges, subtle brand moments
  onBrandTertiary: "#0B63CE", // text and icons on brandTertiary
  ...
  // Lines
  // ---------------------------------------------------------------------------
  border: "#DCE5EF", // hairline outline, 0.5pt or 1pt max: inputs, cards
  borderStrong: "#AFC6DC", // focus rings, selected outlines, 1.5pt max
  divider: "#E5EDF5", // subtle list separators
};
